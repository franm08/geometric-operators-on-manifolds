...
plt.tight_layout()
plt.savefig("outputs/geodesic_terrain.png",dpi=300)
plt.show()
...
if do_animation:
    ...
    ax2.plot_surface(U,V,Z,cmap='terrain',edgecolor='none',alpha=0.8)
    ...
    ani.save("outputs/geodesic_terrain.gif",writer="pillow",fps=60)